...
const nameGreeting = nameCheck(`Tom`)
...
function faveColorFinder(color){
  ...
  if(colorString === `Red`){
    ...
    return `You need to evaluate your favorite color choise`
  }
}
...
//CODE HERE
const aStringFun = function(aString){
  console.log(aString.toUpperCase())
}
aStringFun(sampleString)
...
//CODE HERE
function chocolateFrogs(amount){
  Number.amount
  if(amount % 3 === 0){
    console.log((amount / 3) + ` is how many frogs you could afford.`)
  }else{
    console.log(Math.floor(amount / 3) + ` is how many frogs you could afford, poor boy.`)
  }
}
...
//CODE HERE
// My code does not do that, it runs without this bug so I am just going to leave this empty
...
const arrayIsAscending = funArray()
